...
public class VaxTodo extends Application {
    ...
    private void startApp(Stage stage) {
        ...
        // ControllerMenusNaviguation.gotoMenu(stage, logger, EnumTypeMenuInterface.EMPLOYE, null, new MenuInfos("Guelleh, Mohamed Hassan", Long.parseLong("222222222222"), 222222222));
        // ControllerMenusNaviguation.gotoMenu(stage, logger, EnumTypeMenuInterface.BENEVOLE, null, new MenuInfos("Guelleh, Mohamed Hassan", Long.parseLong("222222222222"), 222222222));
        // ControllerMenusNaviguation.gotoMenu(stage, logger, EnumTypeMenuInterface.GESTION_EMPLOYES, EnumTypeMenuInterface.EMPLOYE, new MenuInfos("Guelleh, Mohamed Hassan", Long.parseLong("222222222222"), 222222222));
        // ControllerMenusNaviguation.gotoMenu(stage, logger, EnumTypeMenuInterface.GESTION_VISITEURS, EnumTypeMenuInterface.EMPLOYE, new MenuInfos("Guelleh, Mohamed Hassan", Long.parseLong("222222222222"), 222222222));
        // ControllerMenusNaviguation.gotoMenu(stage, logger, EnumTypeMenuInterface.GESTION_CALENDRIER, EnumTypeMenuInterface.EMPLOYE, new MenuInfos("Guelleh, Mohamed Hassan", Long.parseLong("222222222222"), 222222222));
        // ControllerMenusNaviguation.gotoMenu(stage, logger, EnumTypeMenuInterface.GESTION_FORMULAIRES, EnumTypeMenuInterface.EMPLOYE, new MenuInfos("Guelleh, Mohamed Hassan", Long.parseLong("222222222222"), 222222222));
    }
